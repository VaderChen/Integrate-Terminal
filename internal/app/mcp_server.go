...
func mcpServerInstructions(contract mcpContract) string {
	...
	return strings.Join([]string{
		...
		"Saved connections and credentials are read only from local JSON files. If saved-site discovery fails, check the data files and retry. RAM operations and the root listing remain usable; a busy data store is reported after a bounded wait.",
