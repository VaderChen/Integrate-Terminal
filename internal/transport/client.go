...
type Client interface {
	...
	Stat(path string) (model.FileEntry, error)
	Upload(localPath, remotePath string, progress func(transferred int64, total int64, speedBps int64) bool) error
	Download(remotePath string, destination io.Writer, progress func(transferred int64, total int64, speedBps int64) bool) error
