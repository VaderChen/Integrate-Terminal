...
export type Messages = {
  ...
  settingsRestServerToken: string;
  settingsRestServerTokenHint: string;
  settingsRestServerTokenShow: string;
  settingsRestServerTokenHide: string;
  settingsRestServerTokenCopy: string;
  settingsRestServerTokenCopySuccess: string;
  settingsRestServerTokenCopyFailed: string;
  settingsRestServerTokenUnavailable: string;
  ...
  purchasePlanFree: string;
  purchasePlanPro: string;
  purchaseTabLimit: (count: number) => string;
  purchaseTabLimitUnlimited: string;
  purchaseCurrentTabs: (current: number, max: number) => string;
  purchaseCurrentTabsUnlimited: (current: number) => string;
  purchaseBuyButton: string;
  purchaseRestoreButton: string;
  purchaseRefreshButton: string;
  purchaseSourceLabel: string;
  purchaseSourceAppStore: string;
  purchaseSourcePurchase: string;
  purchaseSourceRestore: string;
  purchaseSourceRefresh: string;
  purchaseSourceLocal: string;
  purchaseSourceUnknown: string;
